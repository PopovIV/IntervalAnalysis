...
plt.plot(101.5, (min[0] + max[0]) / 2, marker="o", markersize=5, markerfacecolor="red", label="predicted mid")
plt.legend()
...
plt.plot(-10, (min[1] + max[1]) / 2, marker="o", markersize=5, markerfacecolor="red", label="predicted mid")
plt.legend()
...
plt.plot(1000, (min[2] + max[2]) / 2, marker="o", markersize=5, markerfacecolor="red", label="predicted mid")
plt.legend()
